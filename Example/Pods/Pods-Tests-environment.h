...
// MRGMarqueeLabel
#define COCOAPODS_POD_AVAILABLE_MRGMarqueeLabel
#define COCOAPODS_VERSION_MAJOR_MRGMarqueeLabel 0
#define COCOAPODS_VERSION_MINOR_MRGMarqueeLabel 1
#define COCOAPODS_VERSION_PATCH_MRGMarqueeLabel 0
